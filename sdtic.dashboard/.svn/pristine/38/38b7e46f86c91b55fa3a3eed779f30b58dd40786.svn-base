...
<meta http-equiv='description' content='IT INFRA 장애 보고서' />
<title>IT INFRA 장애 보고서</title>
...
<div id="wrap_pop">
    ...
    <div id="hdPop">
        <div class="sect_hLft">
            <div class="txtTit">IT INFRA 장애 보고서</div>
        </div>
    ...
    <div id="cntPop">
        ...
        <div class="sect_iCnt">
            ...
            <fieldset class="frm_src" style="height:600px">
                <legend class="skip"><span>IT INFRA 장애 보고서</span></legend>
...
SearchQuery = function() {
	var url = "http://" + location.host + "/ifc/ifcMainEventReport.do";
    ...
    $.ajax(
    {
        ...
        success: function(data){ 
        	var rexpert_data = {};
        	rexpert_data["rexpertCrf"] = "tic/ifc_trobl_report.crf";                         
