...
<%-- 자바스크립트  --%>  
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecAreclTroblOccrrncManagtLv1.js" type="text/javascript"></script>
...
<div id = "idChart" style="width:120%; height: 100%; top:0px; margin-left:10px;">
