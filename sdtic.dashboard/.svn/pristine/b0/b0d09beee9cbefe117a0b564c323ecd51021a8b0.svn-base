...
<body>
	...
	<div id="wrap_if">
	    <div id="pln_main" class="sctSmrSys tpPln">
	        <div class="areaSys"><!--설계--></div>
	        <div class="areaIndC">
	            <span class="txtItem">설계도서납품</span><br /><span id="data1" class="txtNum">75 %</span>
	        </div>
	        <div class="areaCUsr">
	            <span class="txtItem">금일누적접속자</span><br /><span id="JSobjectProp" class="txtNum">28 명</span>
	        </div>
	    </div>
	</div>
	
	   <%--<img id="img1" src="${contextPath}/images/bucrs/plan_top.png" width="100%" height="90px">
         <table>
            <tr style="height:55px;">
                <td style="width:160px;" align='center'>
                    <table>
                        <tr>
                            <td><center><img src="${contextPath}/images/bucrs/plan3.png" width="80px" height="40px"></center></td>
                        </tr>
                        <tr>
                            <td align='center' valign='top'><font face="돋움" size="3px" color="#FFFFFF"><b>설계</b></font></td>
                        </tr>
                    </table>
                </td>
    ...
    <script type="text/javascript">
         ...
         $(window).load(function() {
            ...
            //setDivHeight('pln_main');
            timerStart();
            //getDsgnAccmltConectr();
            selecttimer();
        });
        ...
        function getDsgnAccmltConectr(){
        	$.ajax({
                url : "${pageContext.request.contextPath}/buc/bucDsgnAccmltConectrAjax.do",
                async : false,
                dataType : 'json',
                
                success :function(json) {
                
                	$('#JSobjectProp').text(json.data[0].connnector + "명");
        	...
        	$.ajax({
                url : "${pageContext.request.contextPath}/buc/bucDsgnRtAjax.do",
                async : false,
                dataType : 'json',
                success :function(json) {
                
                	$('#data1').text(json.data[0].deliverydata + "%");
        ...
        function divColorChange(){
            ...
            if(second<15){
                //var divid = document.getElementById("pln_main");
                //var divid = document.getElementById("img1");
                //divid.style.backgroundColor = "#49bcf3";
                
                $("#pln_main").addClass('sctSmrSys tpPln active');
                //divid.src = "${contextPath}/images/bucrs/plan_top_on.png";
            	...
            	//divid.src = "${contextPath}/images/bucrs/plan_top.png";
            }
