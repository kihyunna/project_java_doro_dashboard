...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecTunnelDetailLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >
			<li class="leftPos_header">터널명</li>
			<li class="middlePos_header">환기설비</li>
			<li class="middlePos_header">계측설비</li>
			<li class="middlePos_header">방제설비</li>
			<li class="middlePos_header">기계설비</li>
