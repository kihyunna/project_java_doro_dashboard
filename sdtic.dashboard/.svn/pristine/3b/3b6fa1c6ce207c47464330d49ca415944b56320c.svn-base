...
<body>
    <div id="main" style="width:100%; height:100%; padding:0px; background:#109c6c;">
        <table >
            <tr style="height:145px;">
                <td style="width:160px;" align='center'>
                    <table>
                        <tr>
                            <td><center><img src="${contextPath}/images/bucrs/build3.png" width="120px" height="100px"></center></td>
                        </tr>
                        <tr>
                            <td align='center' valign='top'><font face="돋움" size="4px" color="#FFFFFF"><b>건설</b></font></td>
                        </tr>
                    </table>
                </td>
    ...
    <script type="text/javascript">
        ...
        function divColorChange(){
            ...
            if(second>=15 && second<30){
                ...
                divid.style.backgroundColor = "#109c6c";
            }
