...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecElctyTunnelLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >
			...
			<li class="middlePos_header">터널등</li>
			<li class="middlePos_header">가로등</li>
			<li class="middlePos_header">화재수신기</li>
