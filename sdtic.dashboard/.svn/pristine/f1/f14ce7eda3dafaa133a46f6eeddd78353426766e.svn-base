...
AjaxQuery = function(DeptCode ) {
	...
	var url = "http://" + location.host + "/FecSlopeLv2.do";
    ...
    $.ajax(
    {
        ...
        success: function(data){ 
        		...
        		$.each(data.Trobl, function(index){
        			...
        			eHtml += '<li class="leftPos" >'+data.Trobl[index].useRotnm+'</li>';	
        			eHtml += '<li class="middlePos" >'+data.Trobl[index].drveDrnm+'</li>';	
        			eHtml += '<li class="middlePos" >'+data.Trobl[index].dstnc+'</li>';	
        			eHtml += '<li class="middlePos"><img src="/images/fecrs/icoNmlBgCb'+data.Trobl[index].impactTrobl+'.png" width="16px"></li>';
        			eHtml += '<li class="rightPos"><img src="/images/fecrs/icoNmlBgCb'+data.Trobl[index].batteryTrobl+'.png" width="16px"></li>';
        			eHtml += '</ul>';        
	        	});  
