...
<body>
	<div id="main" style="width:100%;height:100%; padding:0px; background:#81598c;">
	        <table >
	            <tr style="height:80px;">
	                <td style="width:160px;" align='center'>
	                    <table>
	                        <tr>
	                            <td><center><img src="${contextPath}/images/bucrs/facility3.png" width="120px" height="80px"></center></td>
	                        </tr>
	                    </table>
	                </td>
	    ...
	    <script type="text/javascript">
	        ...
	        function divColorChange(){
	            ...
	            if(second>=45){
	                ...
	                divid.style.backgroundColor = "#81598c";
	            }
