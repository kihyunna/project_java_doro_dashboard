...
<html lang="ko" class="cnt_if">
	...
	<!-- including ECharts file -->
	    ...
	    <script type="text/javascript" src="${contextPath}/js/ifcrs/IfcWebServerView.js"></script>
	...
	<body>
	    ...
	    <script type="text/javascript">
	        ...
	        var timeLineDataCode = new Array();
	        
	        function initData(){
                $.ajax({
                    url : "${pageContext.request.contextPath}/ifc/ifcWebServer.do",
                    async : false,
                    dataType : 'json',
                    data:{
                        'gubun'    : 'WEB'
                    ...
                    success :function(json) {
                        ...
                        for(var i=0;i<json.data.length;i++){
                            if(temp != json.data[i].group1){
                                ...
                                timeLineDataCode[cnt1] = json.data[i].group1;
	        ...
	        function getData(currentIndex){
                $.ajax({
                    ...
                    success :function(json) {
                        ...
                        group1 = timeLineDataCode[currentIndex];
