...
<%-- 자바스크립트  --%>  
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecPwrerUsgqtyMain.js" type="text/javascript"></script>
...
<body>
    <table border="0" cellpadding="0" cellspacing="0">
    	<tr >
    		<td height="43" style="color:#f9f9f9;font-weight:bolder;">
