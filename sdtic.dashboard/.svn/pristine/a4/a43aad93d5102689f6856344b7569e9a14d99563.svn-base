...
<meta http-equiv='description' content='CCTV 장애 현황' />
<title>CCTV 장애 현황</title>
...
<div id="wrap_pop">
    ...
    <div id="hdPop">
        <div class="sect_hLft">
            <div class="txtTit">CCTV 장애 현황</div>
        </div>
    ...
    <div id="cntPop">
        ...
        <div class="sect_iCnt">
            ...
            <fieldset class="frm_src" style="height:600px">
                <legend class="skip"><span>CCTV 장애 현황</span></legend>
...
SearchQuery = function() {
	...
	var url = "http://" + location.host + "/MainFecEventReportCctv.do";
    ...
    $.ajax(
    {
        ...
        success: function(data){ 
        	var rexpert_data = {};
        	rexpert_data["rexpertCrf"] = "tic/fec_event_report_cctv.crf";                         
