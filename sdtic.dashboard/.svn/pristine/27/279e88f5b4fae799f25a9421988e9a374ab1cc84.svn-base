...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecBrineLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >						
			<li class="leftPos_header">노선코드</li>
			<li class="middlePos_header"> 위 치 </li>
			<li class="rightPos_header"> 분사시작 </li>		
			<li class="rightPos_header"> 분사종료 </li>
		</ul>
