...
<html lang="ko" class="cnt_if">
	...
	<!-- including ECharts file -->
	    ...
	    <script type="text/javascript" src="${contextPath}/js/ifcrs/IfcDbCntrlView.js"></script>
	...
	<body>
	    <div id="main" style="width:500px;height:255px;z-index:10;"></div>
	    <div id="mainBorder" style="position:absolute;top:0px;left:0px;width:490px;height:255px;border:solid 5px #f00;display:none;z-index:1;"></div>
	    ...
	    <script type="text/javascript">
            ...
            function getData(){
                $.ajax({
                    url : "${pageContext.request.contextPath}/ifc/ifcDbCntrl.do",
                    async : false,
                    dataType : 'json',
                    data:{
                        'gubun'    : 'DB'
