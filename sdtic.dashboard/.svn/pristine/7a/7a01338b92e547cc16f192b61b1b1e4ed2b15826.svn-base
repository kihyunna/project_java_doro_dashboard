...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecElctyTollgateLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >
			<li class="leftPos_header">영업소명</li>
			<li class="middlePos_header">복합계전기</li>
			<li class="middlePos_header">가로등</li>
			<li class="middlePos_header">태양광인버터</li>
			<li class="middlePos_header">발전기</li>
