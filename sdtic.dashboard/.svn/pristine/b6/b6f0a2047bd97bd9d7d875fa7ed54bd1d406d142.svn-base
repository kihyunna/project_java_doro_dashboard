...
<div id = "idDiv" style="width:100%;height: 275px; margin-top:5px;float:left;background-color:transparent;">	
 <select >
 	<option value="1" selected>수도권본부</option>
 	<option value="2" >강원본부</option>
 	<option value="3" >충북본부</option>
 </select>
  <select >
 	<option value="1" selected>인천</option>
 	<option value="2" >시흥</option>
 	<option value="3" >군포</option>
 	<option value="4" >화성</option>
 	<option value="5" >수원</option>
 	<option value="6" >경기광주</option>
 	<option value="7" >동서울</option>
 </select>
</div>
</body>
</html>