...
<body>
    <div id="main" style="width:100%; height:100%; padding:0px; background:#346755;">
        <table >
            <tr style="height:80px;">
                <td style="width:160px;" align='center'>
                    <table>
                        <tr>
                            <td><center><img src="${contextPath}/images/bucrs/build3.png" width="120px" height="80px"></center></td>
                        </tr>
                    </table>
                </td>
    ...
    <script type="text/javascript">
        ...
        function divColorChange(){
            ...
            if(second>=15 && second<30){
                ...
                divid.style.backgroundColor = "#0fd490";
                $("#main").addClass('magictime swashIn');
            }else{

                var divid = document.getElementById("main");
                $("#main").removeClass("magictime swashIn");
                divid.style.backgroundColor = "#346755";
            }
