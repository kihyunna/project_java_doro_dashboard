...
<body style="height:100%;">
    <div id="main" style="width:100%; height:100%; padding:0px; background:#248cbc;">
        <table>
            <tr style="height:145px;">
                <td style="width:160px;" align='center'>
                    <table>
                        <tr>
                            <td><center><img src="${contextPath}/images/bucrs/plan3.png" width="120px" height="100px"></center></td>
                        </tr>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        function divColorChange(){
            ...
            if(second<15){
                ...
                divid.style.backgroundColor = "#44bcf3";
                ...
                divid.style.backgroundColor = "#248cbc";
            }
