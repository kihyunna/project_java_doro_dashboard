...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecEventListLv2.js" type="text/javascript"></script>
...
/*   	width 수정 */
  	.sctCntt.sct03{width:900px;margin-top:1px;}    	
</style>
...
<div id="idDiv" class="pdd" style="margin-left:5px;">	
	<div class="table_style">
		<!--이벤트 효과 부분-->
		<ul id="ul12345" style="height:33px;width:900px;" class="header" >
			<li class="leftPos_header">발생일시</li>
			<li class="middlePos_header">구분</li>
			<li class="middlePos_header" style="width:250px;">시설물명</li>			
			<li class="rightPos_header">상세 내용</li>
		</ul>
