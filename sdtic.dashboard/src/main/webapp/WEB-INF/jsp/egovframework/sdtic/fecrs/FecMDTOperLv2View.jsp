...
/* 		 border-right: 1px solid #000; /*테이블의 우측 보더를 만듬*/
  	...
  	.sctCntt.sct02{width:360px;padding-right:10px;}  
	...
	<div id = "idTable_mdt" class="sctCntt sct02">
		<table class="tblWgt" summary="수신율별로 금일과 전일의 운행차량 댓수를 보여 준다.">
			...
			<thead>
				<tr>
					<th scope="col">수신율</th>
					<th scope="col">운행차량(전일)</th>
					<th scope="col">운행차량(금일)</th>					
				</tr>
			</thead>
			<tbody>
				<tr class="tpG">
					<th scope="row">95% 이상</th>					
					<td>2</td>
					<td>2</td>
				</tr>
				<tr class="tpY">
...
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecMDTOperLv2.js" type="text/javascript"></script>
