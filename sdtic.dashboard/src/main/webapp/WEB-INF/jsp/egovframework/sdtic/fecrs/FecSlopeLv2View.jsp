...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecSlopeLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >						
			<li class="leftPos_header">사용노선명</li>
			<li class="middlePos_header"> 주행방향명 </li>
			<li class="middlePos_header"> 이정 </li>		
			<li class="middlePos_header"> 충격량 </li>
			<li class="rightPos_header"> 배터리 </li>					
		</ul>
