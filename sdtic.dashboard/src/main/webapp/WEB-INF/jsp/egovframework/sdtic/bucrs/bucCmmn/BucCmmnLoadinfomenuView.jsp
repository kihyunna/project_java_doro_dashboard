...
<body>
	...
	<div class="container" style="position:absolute; width:550px; height:240px; left: 340px; top: 10px; float: left">			
		<div id="theGrid" class="main">
			<section class="grid">
				...
				<a id="gridItem4" class="grid__item" href="#">
					...
					<div class="title title--preview" id="useMenu4" style="width: 40%">설계내역서 등록</div>
