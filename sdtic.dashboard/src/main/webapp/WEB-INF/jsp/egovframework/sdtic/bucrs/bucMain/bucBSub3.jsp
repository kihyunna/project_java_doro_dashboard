...
<body>
    <div id="main" style="width:100%;height:100%; padding:0px; background:#d5a75f;">
        <table >
            <tr style="height:145px;">
                <td style="width:160px;" align='center'>
                    <table>
                        <tr>
                            <td><center><img src="${contextPath}/images/bucrs/corrective.png" width="120px" height="100px"></center></td>
                        </tr>
                        <tr>
                            <td align='center' valign='top'><font face="돋움" size="4px" color="#FFFFFF"><b>유지관리</b></font></td>
                        </tr>
                    </table>
                </td>
    ...
    <script type="text/javascript">
        ...
        function divColorChange(){
            ...
            if(second>=30 && second<45){
                ...
                divid.style.backgroundColor = "#d5a75f";
            }
