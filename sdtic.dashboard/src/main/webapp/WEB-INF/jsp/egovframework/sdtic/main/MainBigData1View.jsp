...
<html lang="ko" class="cnt_if">
	...
	<!-- including ECharts file -->
	    ...
	    <script type="text/javascript" src="${contextPath}/js/main/MainBigData1View.js"></script>
	...
	<body>
	    ...
	    <script type="text/javascript">
            ...
            function getData(){
                $.ajax({
                    url : "${pageContext.request.contextPath}/main/mainBigData1.do",
                    async : false,
                    dataType : 'json',
                    data:{
                        'hostname'    : 'cclwas034'
