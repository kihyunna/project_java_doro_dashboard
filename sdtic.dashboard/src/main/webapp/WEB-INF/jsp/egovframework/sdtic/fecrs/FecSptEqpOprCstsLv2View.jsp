...
<%-- 자바스크립트  --%>  
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecSptEqpOprCstsLv2.js" type="text/javascript"></script>
...
<div id = "idChart" style="width:900px; height: 900px; top:0px; left:0px;">
