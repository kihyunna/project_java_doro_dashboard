...
<head>
<title></title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/fecrs/css/default.css" />
<meta charset="utf-8" />
...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecPltwtrProcessLv2.js" type="text/javascript"></script>
...
<div id="idDiv" class="pdd">	
	<div class="table_style">
		...
		<ul id="ul12345" style="height:33px;width:450px;" class="header" >
			<li class="leftPos_header">휴게소명</li>
			<li class="middlePos_header">스크린조</li>
			<li class="middlePos_header">유량조정조</li>
			<li class="middlePos_header">슬러지인출</li>
			<li class="middlePos_header">폭기조</li>
			<li class="rightPos_header">기타</li>
		</ul>
