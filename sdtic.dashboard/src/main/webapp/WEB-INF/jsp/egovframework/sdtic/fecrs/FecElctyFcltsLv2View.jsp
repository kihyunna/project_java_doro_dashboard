...
<%-- 자바스크립트  --%>
<script src="<%=request.getContextPath()%>/js/fecrs/facilities/FecElctyFcltsLv2.js" type="text/javascript"></script>
...
<div id = "idDiv" style="width:100%;height: 275px; margin-top:5px;float:left;background-color:transparent;">	
	    <div id = "idChart" style="width:0px; height: 275px; top:0px; left:0px; float:left;">		
		</div>

	<div class="table_style">
<!-- 	    제목 고정 -->
		<ul id="ul11" style="height:50px" onclick="hideRow(this)" >
			<li style="margin-left:140px;font-weight: bold; height:50px;">전기설비</li>
		</ul>
		
<!-- 		이벤트 효과 부분 -->
		<ul id="ul12" style="height:36px;" class="header">
			<li style="height:36px;font-size:13px;width:70px;" class="leftPos">NUM</li>
			<li style="height:36px;font-size:13px;width:70px;" class="middlePos">명칭</li>
			<li style="height:36px;font-size:13px;width:70px;" class="middlePos">내 용</li>
			<li style="height:36px;font-size:13px;width:70px;" class="rightPos">발생시간</li>
		</ul>
