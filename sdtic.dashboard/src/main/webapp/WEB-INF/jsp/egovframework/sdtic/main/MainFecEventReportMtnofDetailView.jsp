...
<div id="wrap_pop">
    ...
    <div id="hdPop">
        <div class="sect_hLft">
            <div class="txtTit">시설별 상세 이벤트 현황</div>
        </div>
...
SearchQuery = function() {
	...
	var url = "http://" + location.host + "/MainFecEventReportMtnofDetail.do";
    ...
    $.ajax(
    {
        ...
        success: function(data){ 
        	var rexpert_data = {};
        	rexpert_data["rexpertCrf"] = "tic/fec_event_report_mtnof_detail.crf";                         
