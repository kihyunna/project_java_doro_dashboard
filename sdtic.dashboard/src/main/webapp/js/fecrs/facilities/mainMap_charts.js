...
//			    },			    
	...
	$('#idChart').animate({ left : "400px" },1000);
};

function setChart2(){

	var Options = {		
			 backgroundColor: 'rgba(171,188,184,0.8)',
			 title : {
				 	textStyle : {
			            color: '#fff'
			        },
...
//			    },			    
			    ...
			    series : [
			        {
			            ...
			            markPoint : {
			                ...
			                data : [
			                    {type : 'max', name: '최고', symbolSize:5},
			                    {type : 'min', name: '최소', symbolSize:5}
			                ]
			            },
			            markLine : {
			                symbol : 'none',
	...
	mapChart2 = echarts.init(document.getElementById("idChart_samyeon"));	
	mapChart2.setOption(Options);
	
	$('#idChart_samyeon').animate({ top : "550px" },1000);
}