...
@Component
public class FecEventCctvScheduler3 {
	...
	public void Execute() {
		...
		System.out.println (" 충북본부 CCTV 이벤트 가져오기 시작");	
		...
		try { 
		    ...
		    try {
		    	list = fecTotlInsrTot.checkCCTV("N02723");
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				System.out.println ("충북본부 CCTV 테이블 조회 실패");
			}
...
//					System.out.println( "error Count  :  " + Integer.toString(errCnt) );
//					System.out.println( "tot Count  :  " + Integer.toString(i) );
//					System.out.println( "cctv id  :  " + spin_intg_id);
			...
			// CCTV 이벤트 데이터 삭제(관제 DB)
	 	    try { 
	 	    	fecTotlInsr.fecDeleteCctv("N02723");
	 		} catch (Exception e) {
	 			// TODO Auto-generated catch block
	 			e.printStackTrace();
	 			System.out.println ("충북본부 CCTV 이벤트 데이터 삭제 실패");
	 		}
		    ...
		    // CCTV 이벤트 데이터 추가(관제 DB)
	 	    try { 
	 			...
	 			// TODO Auto-generated catch block
	 			e.printStackTrace();
	 			System.out.println ("충북본부 CCTV 이벤트 데이터 추가 실패");
	 		} 	
...
//		if (bEvent){
//			System.out.println ("충북본부 CCTV 이벤트 발생");
